...
<header>
		<a href="http://localhost:8080/E-commerce-shopping-portal-using-j2ee-technologies-master/Controller?page=index"><h1>Happy Shopping </h1> </a>
		<nav>
			<ul>
	...
	<div class="signup-header">
	 	<h2>Login to <mark>happyshopping</mark></h2>
	</div>
	 ...
	 <input type="hidden" name="page" value="login-form">
	 	...
	 	<p>
	 		New to Happyshopping? <a href="Controller?page=sign-up" style="color:#F24638;">Create Account</a>
	 	</p>
	 </form>
	<br><br><br>
	<footer style="position: fixed;bottom: 0;left: 0;width: 100%;">
		<div class="footer"> &copy; 2019 Copyright:
	      <a href="Controller?page=index"> Vijay.com</a>
	    </div>
	</footer>
